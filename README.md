...
For reference, the X/Y origin point in the bottom left-hand corner should be 87/50 mm from the centre of the left-most 6 mm fixing hole. If you're tiling as I have done, that's the origin of tile 1 and the origin of tile 2 is aligned with the centre of the middle 6 mm fixing hole and 50 mm down.  Zero point Z should be the top of the aluminimum plate.